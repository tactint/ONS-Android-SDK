...
import com.ons.android.core.ExcludedActivityHelper;
...
import com.ons.android.core.TaskExecutor;
import com.ons.android.debug.ONSDebugActivity;
import com.ons.android.debug.FindMyInstallationHelper;
import com.ons.android.di.providers.ActionModuleProvider;
import com.ons.android.di.providers.ONSModuleMasterProvider;
...
import com.ons.android.di.providers.InboxFetcherInternalProvider;
...
import com.ons.android.module.ONSModule;
import com.ons.android.module.OptOutModule;
...
/**
 * Entry point of the ONS library
 */
@PublicSDK
...
public final class ONS {
    ...
    /**
     * Install object build on ONS start
     */
    @Nullable
    private static Install install;

    /**
     * Broadcast receiver of ONS
     */
     ...
     * Notification tag.
     * <p>
     * Notifications displayed by ONS all have this tag.
     * Useful if you need to cancel them, for example.
     */
    public static final String NOTIFICATION_TAG = "ons";

    /**
     * Permission suffix for broadcasts triggered by ONS.
     ...
     */
    public static final String BROADCAST_PERMISSION_SUFFIX = ".ons.permission.INTERNAL_BROADCAST";
    ...
    public static final String ACTION_REGISTRATION_IDENTIFIER_OBTAINED =
        "com.ons.android.intent.action.push.REGISTRATION_IDENTIFIER_OBTAINED";
     ...
     */
    @NonNull
    private static final ONSModule moduleMaster;

    static {
        moduleMaster = ONSModuleMasterProvider.get();
    }

    private ONS() {}

    /**
     * Set the API Key of ONS.<br>
     * <br>
     * You should call this method before any other, only one time.<br>
     * Typically on the onCreate of your Application class.
     *
     * @param apiKey Your ONS API Key
     */
     ...
     *
     * @param migrations EnumSet of Migrations to disable. See {@link ONSMigration}
     */
    public static void disableMigration(@NonNull EnumSet<ONSMigration> migrations) {
        //noinspection ConstantConditions
        if (migrations == null) {
            Logger.error("You cannot use disableMigration with null value.");
            return;
        }
        RuntimeManagerProvider.get().updateConfig(config -> config.setMigrations(ONSMigration.toValue(migrations)));
    }
    ...
    /**
     * Set the log level that ONS should use
     *
     ...
     *               Once your callback ends, ONS will persist the changes.
     */
    public static void updateAutomaticDataCollection(ONSDataCollectionConfig.Editor editor) {
        DataCollectionModuleProvider.get().updateDataCollectionConfig(editor);
    }

    /**
     * Get the id of the current session, random uuid used internally by ONS to identify the app session.
     *
    ...
    public static String getSessionID() {
        ...
        RuntimeManagerProvider
            .get()
            .run(state -> {
                if (ONS.sessionID != null) {
                    sessionID.append(ONS.sessionID);
                }
            });
    ...
    /**
     * Copy ONS's internal data from an intent to another.
     * This is useful if you've got an activity that will not get a chance to start ONS before closing itself,
     * but don't want to break features relying on data put in the intent extras, such as direct open tracking
     * or mobile landings.
     *
     * @param from Intent to read ONS's data from
     * @param to   Intent to copy ONS's data to
     */
    public static void copyONSExtras(@Nullable Intent from, @Nullable Intent to) {
        IntentParser.copyExtras(from, to);
    }

    /**
     * Copy ONS's internal data from intent extras to another bundle.
     * This is useful if you've got an activity that will not get a chance to start ONS before closing itself,
     * but don't want to break features relying on data put in the intent extras, such as direct open tracking
     * or mobile landings.
     *
     ...
     * @param to   Intent to copy ONS's data to
     */
    public static void copyONSExtras(@Nullable Bundle from, @Nullable Bundle to) {
        IntentParser.copyExtras(from, to);
    }
    ...
    /**
     * Opt Out from ONS SDK Usage. Requires ONS to be started.
     * <p>
     ...
     * <p>
     * Opting out will:
     * - Prevent {@link ONS#onStart(Activity)} or {@link ONS#onServiceCreate(Context, boolean)} from doing anything at all
     ...
     * - Make the SDK reject any ONSUserProfile or {@link ONSProfileAttributeEditor#save()} calls
     * - Make the SDK reject calls to {@link ONS.Profile#trackEvent(String)}, {@link ONS.Profile#trackLocation(Location)} and any related methods
     * <p>
     * Even if you opt in afterwards, data that has been generated while opted out WILL be lost.
     * <p>
     * If you're also looking at deleting user data, please use {@link ONS#optOutAndWipeData(Context)}
     * <p>
     * Note that calling this method will stop ONS, effectively simulating calls to {@link ONS#onStop(Activity)}, {@link ONS#onDestroy(Activity)} and {@link ONS#onServiceDestroy(Context)}.
     ...
     * Opt Out from ONS SDK Usage. Requires ONS to be started.
     * <p>
     * Same as {@link ONS#optOut(Context)}, with a completion listener.
     * <p>
     ...
     *
     * @see ONS#optOut(Context)
     */
    public static void optOut(@NonNull Context context, @Nullable ONSOptOutResultListener listener) {
     ...
     * Opt Out from ONS SDK Usage. Requires ONS to be started.
     * <p>
     * Same as {@link ONS#optOut(Context)} but also wipes data.
     * <p>
     * Note that calling this method will stop ONS, effectively simulating calls to {@link ONS#onStop(Activity)}, {@link ONS#onDestroy(Activity)} and {@link ONS#onServiceDestroy(Context)}.
     * Your app should be prepared to handle these cases.
     *
     ...
     * Note: if the SDK has already been opted-out from, this method will instantly call the listener with a *failure* state.
     *
     * @see ONS#optOutAndWipeData(Context)
     */
    public static void optOutAndWipeData(@NonNull Context context, @Nullable ONSOptOutResultListener listener) {
    ...
    private static void _optOut(
        ...
        boolean wipeData,
        @Nullable final ONSOptOutResultListener listener
    ) {
        //noinspection ConstantConditions
        if (context == null) {
        ...
        OptOutModuleProvider
            ...
            .then(value -> {
                ...
                ONS.onStop(a != null ? a : context.getApplicationContext(), false, true);
            })
            .catchException(e -> {
                if (listener != null) {
                    listener.onError();
    ...
    /**
     * Opt In to ONS SDK Usage.
     * <p>
     * This method will be taken into account on next full application start (full process restart)
     * <p>
     * Only useful if you called {@link ONS#optOut(Context)} or {@link ONS#optOutAndWipeData(Context)} or opted out by default in the manifest
     * <p>
    ...
    /**
     * Returns whether ONS has been opted out from or not
     * <p>
    ...
    /**
     * Control whether ONS should enables the Find My Installation feature (default = true)
     * <p>
     * If enabled ONS will copy the current installation id in the clipboard when the application
    ...
    public static final class Debug {
        ...
        /**
         * Start the debug activity. Requires ONS to be started.
         * You should not leave this method in your application as it is just a tool allowing developer to debug ONS info.
         * <p>
        ...
        public static void startDebugActivity(@NonNull Context context) {
            Intent intent = new Intent(context, ONSDebugActivity.class);
    ...
    public static final class Inbox {
         ...
         * ONS must be started for all of the fetcher's features to work, but you can call this method before starting ONS (such as in your activity's onCreate)
         *
         ...
         * @return an instance of ONSInboxFetcher with the wanted configuration
         */
        @NonNull
        public static ONSInboxFetcher getFetcher(@NonNull Context context) {
            //noinspection ConstantConditions
            if (context == null) {
                throw new IllegalArgumentException("Context cannot be null");
            }
            final String installID = new Install(context).getInstallID();
            return new ONSInboxFetcher(InboxFetcherInternalProvider.get(context, installID));
        }
         ...
         */
        @NonNull
        public static ONSInboxFetcher getFetcher(
            ...
            return new ONSInboxFetcher(InboxFetcherInternalProvider.get(context, userIdentifier, authenticationKey));
        }
    }
    ...
    public static final class Push {
         ...
         */
        public static final String PAYLOAD_KEY = "onsPushPayload";
         ...
         * ONS registers, meaning that you won't be able to change it after the first notification.
         ...
         */
        @NonNull
        public static ONSNotificationChannelsManager getChannelsManager() {
            return ONSNotificationChannelsManagerProvider.get();
        }

        /**
         * Dismiss all notifications shown by the application.<br>
         * <br>
         * You should call this method after {@link ONS#onStart(Activity))<br>
         * <br>
         * NB : This method will dismiss even not ONS notifications,
        ...
        /**
         * Adjust the way ONS will display notifications.<br>
        ...
        /**
         * Check if the received push is a ONS one. If you have a custom push implementation into your app you should
         ...
         * @return true if the push is for ONS and you shouldn't handle it, false otherwise
         */
        public static boolean isONSPush(Intent intent) {
            return PushModuleProvider.get().isONSPush(intent);
        }
         ...
         * @return true if the push is for ONS and you shouldn't handle it, false otherwise
         */
        public static boolean isONSPush(RemoteMessage message) {
            return PushModuleProvider.get().isONSPush(message);
        }
        ...
        /**
         * Append ONS data to your open intent so that opens from this push will be tracked by ONS and displayed into your dashboard.
         ...
         */
        public static void appendONSData(Intent pushIntent, Intent openIntent) {
            PushModuleProvider.get().appendONSData(pushIntent, openIntent);
        }
         ...
         * @param openIntent       the intent of the notification the will be triggered when the user clicks on it
         */
        public static void appendONSData(@NonNull Bundle pushIntentExtras, @NonNull Intent openIntent) {
            PushModuleProvider.get().appendONSData(pushIntentExtras, openIntent);
        }
         ...
         * @param openIntent    the intent of the notification the will be triggered when the user clicks on it
         */
        public static void appendONSData(@NonNull RemoteMessage remoteMessage, @NonNull Intent openIntent) {
            PushModuleProvider.get().appendONSData(remoteMessage, openIntent);
        }

        /**
         * Make a PendingIntent suitable for notifications from a given Intent.
         * This is useful for custom receivers, or {@link ONSNotificationInterceptor} implementations.
         * <p>
         ...
         * @param pushIntentExtras Raw extras of the push intent, used to copy data used by ONS to power features such as direct opens, or mobile landings. Cannot be null.
         *                         If these extras don't have valid ONS data in it, a valid PendingIntent will still be returned, but some features might not work correctly.
         ...
         * @param context       Context. Cannot be null.
         * @param intent        The intent you want to be triggered when performing the pending intent. Must be an intent compatible with {@link PendingIntent#getActivity(Context, int, Intent, int)}. Cannot be null.
         * @param remoteMessage Raw Firebase message, used to copy data used by ONS to power features such as direct opens, or mobile landings. Cannot be null.
         *                      If these extras don't have valid ONS data in it, a valid PendingIntent will still be returned, but some features might not work correctly.
         * @return A PendingIntent instance, wrapping the given Intent.
         */
        @NonNull
        ...
        /**
         * Make a PendingIntent suitable for notifications from a given deeplink. It will use ONS's builtin action activity.
         * <p>
         * This is useful for custom receivers, or {@link ONSNotificationInterceptor} implementations.
         *
         * @param context          Context. Cannot be null.
         ...
         * @param pushIntentExtras Raw extras of the push intent, used to copy data used by ONS to power features such as direct opens, or mobile landings. Cannot be null.
         *                         If these extras don't have valid ONS data in it, a valid PendingIntent will still be returned, but some features might not work correctly.
         * @return A PendingIntent set to open ONS's builtin action activity to open the specified deeplink. Can be null if the deeplink is not valid.
         */
        @Nullable
        @SuppressWarnings("ConstantConditions")
         ...
         * @param context       Context. Cannot be null.
         * @param deeplink      Deeplink string. Cannot be null.
         * @param remoteMessage Raw Firebase message content, used to copy data used by ONS to power features such as direct opens, or mobile landings. Cannot be null.
         *                      If these extras don't have valid ONS data in it, a valid PendingIntent will still be returned, but some features might not work correctly.
         * @return A PendingIntent set to open ONS's builtin action activity to open the specified deeplink. Can be null if the deeplink is not valid.
         */
        @Nullable
        ...
        /**
         * Should the developer handle and display this push, or will ONS display it?
         * Use this method to know if ONS will ignore this push, and that displaying it is your responsibility
         *
         * @return true if the push will not be processed by ONS and should be handled, false otherwise
         */
        ...
        /**
         * Call this method to display the notification for this intent.
         * Allows an interceptor to be set for this call, overriding the global one set using {@link ONS.Push#setNotificationInterceptor(ONSNotificationInterceptor)}
         *
         * @param context Android's context
         * @param intent Android's intent
         */
        public static void displayNotification(
            @NonNull Context context,
            @NonNull Intent intent,
            @Nullable ONSNotificationInterceptor interceptor
        ) {
        ...
        /**
         * Call this method when you just displayed a ONS push notification by yourself.
         *
         * @param context Android's context
         ...
         * <p>
         * ONS <b>MUST</b> be started in order to use this method.
         *
         * @return A push registration, null if unavailable.
         */
        @Nullable
        public static ONSPushRegistration getRegistration() {
            return PushModuleProvider.get().getRegistration();
        }

        /**
         * Set a notification interceptor. It allows you to tweak various parts of a notification that ONS generates before displaying it.
         *
         * @param interceptor A {@link ONSNotificationInterceptor} subclass. Null to remove a previously set one.
         */
        public static void setNotificationInterceptor(@Nullable ONSNotificationInterceptor interceptor) {
            PushModuleProvider.get().setNotificationInterceptor(interceptor);
        }

        /**
         * Force ONS to renew the push token.
        ...
        public static void requestNotificationPermission(
            @NonNull Context context,
            @Nullable ONSPermissionListener listener
        ) {
    ...
    public static final class EventDispatcher {
         ...
         * The ONS SDK must be opt-in for the dispatcher to receive events.
         *
         * @param dispatcher The ONS Event Dispatcher to add
         */
        public static void addDispatcher(ONSEventDispatcher dispatcher) {
         ...
         *
         * @param dispatcher The ONS Event Dispatcher to remove
         */
        public static boolean removeDispatcher(ONSEventDispatcher dispatcher) {
            return EventDispatcherModuleProvider.get().removeEventDispatcher(dispatcher);
        }

        /**
         * Represents the type of the dispatched event in {@link ONSEventDispatcher#dispatchEvent(Type, Payload)}.
         * Declared under ONS.EventDispatcher to avoid ambiguity with {@link ONSEventAttributes}.
         */
        @PublicSDK
        public enum Type {
        ...
        /**
         * Accessor to the payload of the dispatched event in {@link ONSEventDispatcher#dispatchEvent(Type, Payload)}.
         * Declared under ONS.EventDispatcher to avoid ambiguity with {@link ONSEventAttributes} and {@link ONSPushPayload}.
         */
        @PublicSDK
        public interface Payload {
             ...
             */
            @Nullable
            ONSMessage getMessagingPayload();
    ...
    public static final class User {
        ...
        /**
         * Get the unique installation ID, generated by ONS. ONS must be started to read it.
         *
         * @return ONS-generated installation ID. Might be null if ONS isn't started.
         */
        @Nullable
        public static String getInstallationID() {
            // Store as a local variable so that install can't change between the null check and return.
            Install install = ONS.install;
            if (install != null) {
         ...
         * fetchTagCollections. This doesn't affect data set on profiles using ONS.Profile.
         */
    ...
    public static final class Profile {
         ...
         * <p>
         * ONS must be started to save it.
         ...
         *
         * @return A ONSProfileAttributeEditor instance.
         */
        @NonNull
        public static ONSProfileAttributeEditor editor() {
            return new ONSProfileAttributeEditor();
        }

        /**
         * Track an event.
         * You can call this method from any thread. ONS must be started at some point, or events won't be sent to the server.
         *
         ...
         */
        public static void trackEvent(@NonNull String event, @Nullable ONSEventAttributes attributes) {
            ProfileModuleProvider.get().trackPublicEvent(event, attributes);
        }

        /**
         * Track a location update.
         * You can call this method from any thread. ONS must be started at some point, or location updates won't be sent to the server.<br>
    ...
    public static final class Messaging {
        ...
        public interface LifecycleListener {
             ...
             */
            void onONSMessageShown(@Nullable String messageIdentifier);
             ...
             * @param messageIdentifier Analytics message identifier string. Can be null.
             */
            void onONSMessageClosed(@Nullable String messageIdentifier);
             ...
             *                          If the index is greater than or equal to zero, you can cast the action to {@link ONSMessageCTA} to get the CTA's label.
             ...
             */
            default void onONSMessageActionTriggered(
                @Nullable String messageIdentifier,
                int index,
                @NonNull ONSMessageAction action
            ) {}
             ...
             *                          or the 'onsAnalyticsID' get parameter of a link.
             * @param action            Action that will be performed, can be null. Some fields might be null.
             *                          DO NOT run the action yourself: the SDK will automatically do it.
             */
            default void onONSMessageWebViewActionTriggered(
                @Nullable String messageIdentifier,
                @Nullable String analyticsID,
                @Nullable ONSMessageAction action
            ) {}
             ...
             * @param messageIdentifier Analytics message identifier string. Can be null.
             */
            default void onONSMessageCancelledByUser(@Nullable String messageIdentifier) {}
             ...
             * @param messageIdentifier Analytics message identifier string. Can be null.
             */
            default void onONSMessageCancelledByAutoclose(@Nullable String messageIdentifier) {}
             ...
             * @param messageIdentifier Analytics message identifier string. Can be null.
             */
            default void onONSMessageCancelledByError(@Nullable String messageIdentifier) {}
        }
        ...
        public interface LifecycleListener2 extends LifecycleListener {
             ...
             * @return true if you handled the message, false if you want to let ONS continue processing it.
             ...
             */
            boolean onONSInAppMessageReady(@NonNull ONSInAppMessage message);
        }
        ...
        public interface DisplayHintProvider {
            DisplayHint getONSMessageDisplayHint(ONSMessage message);
        }
        ...
        public static class DisplayHint {
             ...
             * ONS will use the given view as a base to walk up the view tree until it reaches the window's content view, or a CoordinatorLayout.
             */
            @SuppressWarnings("ConstantConditions")
            ...
            /**
             * Embed display hint:
             * ONS will embed the banner in the given FrameLayout, no questions asked.
             */
            @SuppressWarnings("ConstantConditions")
         ...
         * <p>
         * If you disable automatic mode, you will have to implement {@link #loadFragment(Context, ONSMessage)}
         *
        ...
        /**
         * Override the {@link Typeface} (aka font) used by ONS's messaging views.
         ...
         * <p>
         * If the specified message contains a banner, this method will throw a {@link ONSMessagingException}.
         * <br/>
         * You should then fallback on {@link #loadBanner(Context, ONSMessage)}, or attempt it before,
         * as there is currently no way of checking whether a ONSMessage contains a banner, an interstitial,
         ...
         * @throws ONSMessagingException When loading fail
         */
        @NonNull
        public static DialogFragment loadFragment(@NonNull Context context, @NonNull ONSMessage message)
            throws ONSMessagingException {
        ...
        /**
         * Load the {@link ONSBannerView} corresponding to the message payload.
         * <br>
         * This method should be called from your UI thread.
         * <p>
         * If the message does not contain a banner, a {@link ONSMessagingException} will be thrown.
         *
         * @param context Your activity's context. Can't be null.
         * @param message Message to display. Can't be null.
         ...
         */
        @NonNull
        public static ONSBannerView loadBanner(@NonNull Context context, @NonNull ONSMessage message)
            throws ONSMessagingException {
            return MessagingModuleProvider.get().loadBanner(context, message, message.getJSON());
        }

        /**
         * Asynchronously show the {@link ONSMessage}. It will be displayed in a dedicated activity ({@link MessagingActivity}).
         * <p>
         * Note that if this method will work even if ONS is in do not disturb mode.
         * <p>
         ...
         * {@link ONS.Messaging.DisplayHintProvider} in your activity.
         *
         * @param context Your activity's context, Can't be null.
         * @param message Message to show. Can't be null.
         */
        @SuppressWarnings("ConstantConditions")
        public static void show(@NonNull Context context, @NonNull ONSMessage message) {
            if (context == null) {
                throw new IllegalArgumentException("context can't be null");
            }
            if (message == null) {
        ...
        /**
         * Toggles whether ONS.Messaging should entier its "do not disturb" (DnD) mode, or exit it.
         * <p>
         * While in DnD, ONS will not display landings, not matter if they've been triggered by notifications or an In-App Campaign, even in automatic mode.
         * </p><p>
         * This mode is useful for times where you don't want ONS to interrupt your user, such as during a splashscreen, a video or an interstitial ad.
         * </p><p>
         * If a message should have been displayed during DnD, ONS will enqueue it, overwriting any previously enqueued message.<br/>
         * When exiting DnD, ONS will not display the message automatically: you'll have to call the queue management methods to display the message, if you want to.<br/>
        ...
        /**
         * Check if ONS Messaging is currently in Do Not Disturb mode
         */
        ...
        /**
         * Check if ONS currently has a pending message, without forgetting it.
         *
         ...
         * <p>
         * Note: Calling this removes the pending message from ONS's queue. Further calls to this
         * method will return null, until another message gets enqueues.
         *
         * @return The enqueued message, if any.
         */
        @Nullable
        public static ONSMessage popPendingMessage() {
    ...
    public static final class Actions {
        ...
        /**
         * Register an action with ONS.
         * <br/>
         * If an action already exists for that identifier, it will be replaced. Identifiers are not case-sensitive.
         * Note that the action identifier cannot start with "ons.", as they are reserved by the SDK.
        ...
        /**
         * Unregister an action from ONS.
         * <br/>
         * Trying to unregister an action that has not be unregistered will silently fail.
         * Note that trying to unregister an action that starts with "ons." will throw an exception.
         *
         ...
         *
         * @param actionIdentifier Action identifier. ONS internal actions cannot be called using this method.
        ...
        /**
         * Set a deeplink interceptor. It allows you to tweak how ONS will open your activity.
         *
         * @param interceptor A {@link ONSDeeplinkInterceptor} interface. Null to remove a previously set one.
         */
        public static void setDeeplinkInterceptor(@Nullable ONSDeeplinkInterceptor interceptor) {
    ...
    public static void onCreate(final Activity activity) {
        ...
        // Check if the activity should be excluded from ons's lifecycle and save the intent if needed
    ...
    /**
     * Method to call on your main activity {@link Activity#onStart()} to start ONS and support URL scheme events.<br>
     * You must call this method before any other on ONS.<br>
     * <br>
     * Will fail and log an Error if <ul>
     * <li>Given {@code activity} is null</li>
     * <li>You call it before calling {@link ONS#start(String)}</li>
    ...
    public static void onStart(final Activity activity) {
        doONSStart(activity, false, true);
    }

    /**
     * Method to call on your service {@link Service#onCreate()} to start ONS.<br>
     * You must call this method before any other on ONS.<br>
     * Note that all ONS functionality is not available in this mode. See the documentation for more info.<br>
     * <br>
    ...
    public static void onServiceCreate(final Context context, final boolean userActivity) {
        doONSStart(context, true, userActivity);
    }

    /**
     * Method to call on your service {@link Service#onDestroy()} to stop ONS.<br>
     * Calling this method if ONS is already stopped or not started will do nothing<br>
     * <br>
     *
     * @param context The service or application context
     */
     ...
     * Calling this method if ONS is already stopped or not started will do nothing
     *
     * @param intent Android's intent
     */
    ...
    /**
     * Start ONS with a context
     */
    private static void doONSStart(final Context context, final boolean bumpRetainCount, final boolean userActivity) {
        ...
        boolean hasStarted = RuntimeManagerProvider
            ...
            .changeState((state, config) -> {
                if (config == null) {
                    Logger.error(
                        "You must set the configuration before starting ONS. Please call setConfig on onCreate of your Application subclass"
                    );
                    return null;
                }
                ...
                if (!userActivity || lastUserStart != null) { // Force a start if ONS was started but without user activity and is now started with userActivity
                ...
                if (context == null) {
                    Logger.error("ONS start called with null context, aborting start");
                    return null;
                }
                ...
                if (OptOutModuleProvider.get().isOptedOutSync(context)) {
                    if (!didLogOptOutWarning) {
                        ...
                        Logger.error("ONS was opted out from: refusing to start.");
                    }
                    return null;
                }
                ...
                if (context instanceof Activity) {
                     ...
                     * This fixes an issue where transparent activities would make ONS incorrectly stop.
                     *
                     * If a translucent or floating activity is the first one, disregard this.
                     * This introduces a edge case where if the transparent activity is the first one, ONS will stop when returning on it.
                     *
                    ...
                    if (MessagingModuleProvider.get().isInAutomaticMode()) {
                        if (intentParser.hasLanding()) {
                            if (intentParser.isLandingAlreadyShown()) {
                                ...
                                final ONSMessage message = intentParser.getLanding();
                                if (message != null) {
                ...
                if (state == State.OFF) {
                    ...
                    moduleMaster.onsContextBecameAvailable(applicationContext);
                    ...
                    if (!GenericHelper.checkPermission("android.permission.INTERNET", applicationContext)) {
                        Logger.error(
                            "ONS needs android.permission.INTERNET, please update your manifest, aborting start"
                        );
                        return null;
                    }
                    ...
                    if (config.getApikey() == null) {
                        Logger.error("API key provided in ONS.start is null, aborting start");
                        return null;
                    }
                     ...
                     */
                    if (ONS.install == null) {
                        ONS.install = new Install(applicationContext);
                    }

                    /*
                     * Create new session id
                     */
                    ONS.sessionID = UUID.randomUUID().toString();

                    /*
                     * Init & register broadcast receiver
                     */
                    if (ONS.receiver == null) {
                        ONS.receiver = new InternalBroadcastReceiver();
                ...
                if (intentParser != null && fromPush.get()) {
                    if (intentParser.isOpenAlreadyTracked()) {
                        ...
                        try {
                            ...
                            if (pushBundle != null) {
                                ONSPushPayload pushPayload = ONSPushPayload.payloadFromReceiverExtras(pushBundle);
                        ...
                        } catch (ONSPushPayload.ParsingException | IllegalArgumentException e) {
        ...
        if (hasStarted) {
            ...
            runtimeManager.readConfig(config -> {
                if (config.getApikey() != null && config.getApikey().toLowerCase(Locale.US).startsWith("dev")) {
                    Logger.warning(
                        "ONS (" + Parameters.SDK_VERSION + ") is running in dev mode (your API key is a dev one)"
                    );
                }
            });

            final String installID = ONS.User.getInstallationID();
            if (installID != null) {
        ...
        boolean hasChanged = RuntimeManagerProvider
            ...
            .changeStateIf(
                ...
                (state, config) -> {
                    ...
                    /*
                     * Is a service or activity still holding ONS?
                     */
                    if (
                        RuntimeManagerProvider.get().getActivity() != null ||
                        RuntimeManagerProvider.get().isRetainedByService()
                    ) {
                        Logger.internal("onStop called, but ONS is retained by a Service or Activity");
                        return null;
                    }
    ...
    /**
     * Finish the ONS library runtime
     */
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                case TaskExecutor.INTENT_WORK_FINISHED:
                    ONS.onWebserviceExecutorWorkFinished();
                    break;
