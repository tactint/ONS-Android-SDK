...
import com.ons.android.BuildConfig;
import com.ons.android.di.providers.KVUserPreferencesStorageProvider;
...
public final class Parameters {
    ...
    /**
     * Common part of the default crypt key base 64 encoded (4 char long) used to
    ...
    /**
     * Common part of the signature crypt key base 64 encoded (4 char long) used to
     * decrypt external data
     ...
     */
    public static final String DOMAIN_URL = "https://pfs.gdn/";

    /**
     * Environement var to get ONS plugin version (to put it into User-Agent)
     */
    public static final String PLUGIN_VERSION_ENVIRONEMENT_VAR = "ons.plugin.version";
    /**
     * Environement var to get ONS bridge version (to put it into User-Agent)
     */
    public static final String BRIDGE_VERSION_ENVIRONEMENT_VAR = "ons.bridge.version";
    ...
    private static final String BASE_WS_URL = "https://" + BuildConfig.WS_DOMAIN + "/" + SDK_VERSION;
     ...
     */
    public static final String DISPLAY_RECEIPT_WS_URL = "https://" + BuildConfig.WS_DOMAIN + "/a/%s";
    /**
     * URL of the metrics WS
     */
    public static final String METRIC_WS_URL = "https://" + BuildConfig.WS_DOMAIN + "/metrics/api-sdk";
    /**
    ...
    static
    {
        ...
        appParameters.put(ParameterKeys.SCHEME_CODE_PATTERN, 				"^ons[A-Za-z0-9]{4,}://unlock/code/([^/\\?]+)");
    }
     ...
     */
    public static final String PARAMETERS_KEY_PREFIX = "ons_parameter_";
     ...
     * @param save  if true, the value will be here at next app launch, it will be
     *              lost otherwise
     */
