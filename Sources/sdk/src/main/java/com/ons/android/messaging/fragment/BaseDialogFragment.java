...
public abstract class BaseDialogFragment<T extends Message>
    ...
    protected void setMessageArguments(ONSMessage payloadMessage, T messageModel) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            ONSMessage payloadMessage = getPayloadMessage();
    ...
    protected ONSMessage getPayloadMessage() {
        try {
            return ONSMessage.getMessageForBundle(getArguments());
