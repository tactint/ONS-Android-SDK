...
/**
 * Internal SDK representation of an Omnichannel ONS Profile
 */
public class ProfileUpdateOperation {
     ...
     */
    @Nullable
    private ONSEmailSubscriptionState emailMarketing;
     ...
     */
    @Nullable
    public ONSEmailSubscriptionState getEmailMarketing() {
     ...
     */
    public void setEmailMarketing(@NonNull ONSEmailSubscriptionState emailMarketing) {
