...
public final class InboxDatasource {
            ...
            for (String key : notification.keySet()) {
                switch (key) {
                    case "sendId":
                        ...
                        break;
                    case ONS.Push.TITLE_KEY:
                        String title = notification.getString(ONS.Push.TITLE_KEY);
                        notificationsValues.put(InboxDatabaseHelper.COLUMN_TITLE, title);
                        break;
                    case ONS.Push.BODY_KEY:
                        String body = notification.getString(ONS.Push.BODY_KEY);
    ...
    private InboxNotificationContentInternal parseNotification(Cursor cursor) {
        try {
            ...
            final InternalPushData onsData = new InternalPushData(payload.getString("com.ons"));
