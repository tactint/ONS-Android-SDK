...
import com.ons.android.messaging.view.formats.UniversalRootView;
...
public class UniversalTemplateFragment
    ...
    public static UniversalTemplateFragment newInstance(ONSMessage payloadMessage, UniversalMessage messageModel) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(
            STYLE_NO_FRAME,
            showStatusbar
                ? R.style.com_onssdk_UniversalDialogTheme
                : R.style.com_onssdk_UniversalDialogTheme_Fullscreen
        );
