...
//
package com.ons.android.msgpack.core;

import static com.ons.android.msgpack.core.MessagePack.Code.ARRAY16;
import static com.ons.android.msgpack.core.MessagePack.Code.ARRAY32;
import static com.ons.android.msgpack.core.MessagePack.Code.BIN16;
import static com.ons.android.msgpack.core.MessagePack.Code.BIN32;
import static com.ons.android.msgpack.core.MessagePack.Code.BIN8;
import static com.ons.android.msgpack.core.MessagePack.Code.EXT16;
import static com.ons.android.msgpack.core.MessagePack.Code.EXT32;
import static com.ons.android.msgpack.core.MessagePack.Code.EXT8;
import static com.ons.android.msgpack.core.MessagePack.Code.FALSE;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXARRAY_PREFIX;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXEXT1;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXEXT16;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXEXT2;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXEXT4;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXEXT8;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXMAP_PREFIX;
import static com.ons.android.msgpack.core.MessagePack.Code.FIXSTR_PREFIX;
import static com.ons.android.msgpack.core.MessagePack.Code.FLOAT32;
import static com.ons.android.msgpack.core.MessagePack.Code.FLOAT64;
import static com.ons.android.msgpack.core.MessagePack.Code.INT16;
import static com.ons.android.msgpack.core.MessagePack.Code.INT32;
import static com.ons.android.msgpack.core.MessagePack.Code.INT64;
import static com.ons.android.msgpack.core.MessagePack.Code.INT8;
import static com.ons.android.msgpack.core.MessagePack.Code.MAP16;
import static com.ons.android.msgpack.core.MessagePack.Code.MAP32;
import static com.ons.android.msgpack.core.MessagePack.Code.NIL;
import static com.ons.android.msgpack.core.MessagePack.Code.STR16;
import static com.ons.android.msgpack.core.MessagePack.Code.STR32;
import static com.ons.android.msgpack.core.MessagePack.Code.STR8;
import static com.ons.android.msgpack.core.MessagePack.Code.TRUE;
import static com.ons.android.msgpack.core.MessagePack.Code.UINT16;
import static com.ons.android.msgpack.core.MessagePack.Code.UINT32;
import static com.ons.android.msgpack.core.MessagePack.Code.UINT64;
import static com.ons.android.msgpack.core.MessagePack.Code.UINT8;
import static com.ons.android.msgpack.core.Preconditions.checkNotNull;

import com.ons.android.msgpack.core.buffer.MessageBuffer;
import com.ons.android.msgpack.core.buffer.MessageBufferOutput;
import com.ons.android.msgpack.value.Value;
...
public class MessagePacker implements Closeable, Flushable {
    ...
    /**
     * Create an MessagePacker that outputs the packed data to the given {@link com.ons.android.msgpack.core.buffer.MessageBufferOutput}.
     ...
     *
     * @param out MessageBufferOutput. Use {@link com.ons.android.msgpack.core.buffer.OutputStreamBufferOutput}, {@link com.ons.android.msgpack.core.buffer.ChannelBufferOutput} or
     *            your own implementation of {@link com.ons.android.msgpack.core.buffer.MessageBufferOutput} interface.
     */
    ...
    private void prepareEncoder() {
        if (encoder == null) {
             ...
             *
             * com.ons.android.msgpack.core.MessageStringCodingException: java.nio.charset.MalformedInputException: Input length = 1
             *     at com.ons.android.msgpack.core.MessagePacker.encodeStringToBufferAt(MessagePacker.java:467) ~[msgpack-core-0.8.6.jar:na]
             *     at com.ons.android.msgpack.core.MessagePacker.packString(MessagePacker.java:535) ~[msgpack-core-0.8.6.jar:na]
             *
