...
import com.ons.android.profile.ProfileDataHelper.AttributeValidationException;
 ...
 * <p>
 * The ONS Profile Attribute Editor allows you to update profiles to:
 * <p>
 * Set attributes
 ...
 */
@PublicSDK
public class ONSProfileAttributeEditor extends InstallDataEditor {

    /**
     * Logger tag
     */
    private static final String TAG = "ONSProfileAttributeEditor";
     ...
     */
    @Override
    public ONSProfileAttributeEditor setLanguage(final @Nullable String language) {
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setRegion(final @Nullable String region) {
     ...
     * or to call {@link ONS.Profile#identify(String)} method before this one.
     * @param email Email address string
     * @return This object instance, for method chaining.
     */
    public ONSProfileAttributeEditor setEmailAddress(final @Nullable String email) {
        Context context = RuntimeManagerProvider.get().getContext();
        if (context == null) {
            Logger.error(TAG, "ONS does not have a context yet. Make sure ONS is started beforehand.");
            return this;
        }
        ...
        if (customUserID == null) {
            Logger.error(
                TAG,
                "You cannot set/reset an email to an anonymous profile. Please use the `ONS.Profile.identify` method beforehand."
            );
            return this;
        }
     ...
     * @return This object instance, for method chaining.
     */
    public ONSProfileAttributeEditor setEmailMarketingSubscription(@NonNull ONSEmailSubscriptionState state) {
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, final long value) {
        try {
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, final double value) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, final boolean value) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, @NonNull final Date value) {
        try {
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, final @NonNull String value) {
        try {
            ProfileDataHelper.assertNotNull(value);
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, final @NonNull URI value) {
        try {
            ProfileDataHelper.assertNotNull(value);
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor setAttribute(final @NonNull String key, final @NonNull List<String> value) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor removeAttribute(@NonNull String key) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor addToArray(final @NonNull String key, final @NonNull String value) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
            if (ProfileDataHelper.isNotValidStringValue(value)) {
                Logger.error(
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor addToArray(final @NonNull String key, final @NonNull List<String> values) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor removeFromArray(final @NonNull String key, final @NonNull String value) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
            if (ProfileDataHelper.isNotValidStringValue(value)) {
                Logger.error(
     ...
     * @return This object instance, for method chaining
     */
    public ONSProfileAttributeEditor removeFromArray(final @NonNull String key, final @NonNull List<String> values) {
        try {
            String normalizedKey = ProfileDataHelper.normalizeAttributeKey(key);
            if (ProfileDataHelper.isNotValidStringArray(values)) {
                Logger.error(
     ...
     * Note if ONS is not started, your changes will be enqueue until it start.
