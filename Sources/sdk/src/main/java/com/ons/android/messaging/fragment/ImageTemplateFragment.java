...
import com.ons.android.messaging.view.formats.ImageFormatView;
...
public class ImageTemplateFragment
    ...
    public static ImageTemplateFragment newInstance(ONSMessage payloadMessage, ImageMessage messageModel) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int theme = getMessageModel().isFullscreen
            ? R.style.com_onssdk_ImageDialogFullscreenTheme
            : R.style.com_onssdk_ImageDialogModalTheme;
