...
import com.ons.android.post.MessagePackPostDataProvider;
...
public abstract class MessagePackWebservice extends Webservice implements TaskRunnable {
    ...
    protected Map<String, String> getHeaders() {
        ...
        header.put("x-ons-protocol-version", MSGPACK_SCHEMA_VERSION);
        header.put("x-ons-sdk-version", Parameters.SDK_VERSION);
        return header;
    }
