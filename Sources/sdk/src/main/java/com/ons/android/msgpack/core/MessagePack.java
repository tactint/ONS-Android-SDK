...
import com.ons.android.msgpack.core.buffer.ArrayBufferInput;
import com.ons.android.msgpack.core.buffer.ByteBufferInput;
import com.ons.android.msgpack.core.buffer.ChannelBufferInput;
import com.ons.android.msgpack.core.buffer.ChannelBufferOutput;
import com.ons.android.msgpack.core.buffer.InputStreamBufferInput;
import com.ons.android.msgpack.core.buffer.MessageBufferInput;
import com.ons.android.msgpack.core.buffer.MessageBufferOutput;
import com.ons.android.msgpack.core.buffer.OutputStreamBufferOutput;
 ...
 *   <tr><td>{@link com.ons.android.msgpack.core.buffer.MessageBufferInput}</td><td>{@link #newDefaultUnpacker(MessageBufferInput)}</td><td>{@link MessageUnpacker}</td></tr>
 * </table>
 *
 * <p>
 ...
 *   <tr><td>{@link com.ons.android.msgpack.core.buffer.MessageBufferOutput}</td><td>{@link #newDefaultPacker(MessageBufferOutput)}</td><td>{@link MessagePacker}</td></tr>
 * </table>
 */
public class MessagePack {
     ...
     * <p>
     * {@link com.ons.android.msgpack.core.buffer.MessageBufferOutput} is an interface that lets applications customize memory
     ...
     * <p>
     * {@link com.ons.android.msgpack.core.buffer.MessageBufferInput} is an interface that lets applications customize memory
    ...
    public static class PackerConfig implements Cloneable {
         ...
         * {@link com.ons.android.msgpack.core.buffer.MessageBufferOutput#flush()} before writing more data (default: 8192).
         */
