...
public class UserDataDebugFragment extends Fragment {
    ...
    private String formatAttribute(ONSUserAttribute attribute) {
        if (attribute.type == ONSUserAttribute.Type.DATE) {
    ...
    private void loadAttributes() {
        ...
        ONS.User.fetchAttributes(
            requireContext(),
            new ONSAttributesFetchListener() {
                @Override
                public void onSuccess(@NonNull Map<String, ONSUserAttribute> attributes) {
                    attributeAdapter.setNotifyOnChange(false);
                    for (Map.Entry<String, ONSUserAttribute> entry : attributes.entrySet()) {
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.com_onssdk_user_data_debug_fragment, container, false);
        customUserId = view.findViewById(R.id.com_onssdk_user_data_debug_fragment_user_id);
        attributeList = view.findViewById(R.id.com_onssdk_user_data_debug_fragment_attribute_list);
        collectionList = view.findViewById(R.id.com_onssdk_user_data_debug_fragment_collection_list);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (userId == null) {
            customUserId.setText(R.string.com_onssdk_debug_view_empty);
        } else {
