 ...
 * @hide
 */
class StartWebservice extends ONSQueryWebservice implements TaskRunnable {
    ...
    protected List<Query> getQueries() {
        ...
        ONSPushRegistration registration = PushModuleProvider.get().getRegistration(applicationContext);
