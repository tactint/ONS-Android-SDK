...
/**
 * ONS webservice that extends {@link Webservice} and can access {@link SystemParameterHelper}.<br>
 * Contains common methods to all webservices
 *
 * @hide
 */
public abstract class ONSWebservice extends Webservice {

    private static final String TAG = "ONSWebservice";
     ...
     */
    protected ONSWebservice(Context context, RequestType type, String baseURLFormat, String... parameters)
        throws MalformedURLException {
        super(context, type, baseURLFormat, addONSApiKey(parameters));
