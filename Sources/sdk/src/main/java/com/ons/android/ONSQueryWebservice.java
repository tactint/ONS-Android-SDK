...
import com.ons.android.post.JSONPostDataProvider;
...
import com.ons.android.query.serialization.deserializers.ResponseDeserializer;
 ...
 * @hide
 */
abstract class ONSQueryWebservice extends ONSWebservice {

    private static final String TAG = "ONSQueryWebservice";
     ...
     */
    protected ONSQueryWebservice(Context context, RequestType type, String baseURLFormat, String... parameters)
        throws MalformedURLException {
