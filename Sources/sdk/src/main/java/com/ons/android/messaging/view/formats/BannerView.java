...
import com.ons.android.messaging.view.CloseButton;
import com.ons.android.messaging.view.CountdownView;
import com.ons.android.messaging.view.FlexboxLayout;
import com.ons.android.messaging.view.helper.ImageHelper;
import com.ons.android.messaging.view.helper.StyleHelper;
import com.ons.android.messaging.view.helper.ViewCompat;
import com.ons.android.messaging.view.percent.PercentRelativeLayout;
import com.ons.android.messaging.view.roundimage.RoundedImageView;
import com.ons.android.messaging.view.styled.Button;
import com.ons.android.messaging.view.styled.SeparatedFlexboxLayout;
...
public class BannerView
    ...
    public BannerView(
        ...
        contentLayout.setId(R.id.com_onssdk_messaging_content_view);
    ...
    private SeparatedFlexboxLayout makeContentLayout(Map<String, String> contentStyleRules) {
        ...
        final TextView bodyTv = (TextView) inflater.inflate(
            R.layout.com_onssdk_messaging_scrollabletextview,
            layout,
            false
        );
    ...
    private void addImage() {
        if (message.imageURL != null) {
            ...
            imageView.setId(R.id.com_onssdk_messaging_image_view);
    ...
    private void addCountdownView() {
        if (canAutoClose() && message.autoCloseDelay > 0) {
            ...
            countdownView.setId(R.id.com_onssdk_messaging_countdown_progress);
