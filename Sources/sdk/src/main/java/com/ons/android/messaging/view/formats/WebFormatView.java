package com.ons.android.messaging.view.formats;

import static android.widget.RelativeLayout.ALIGN_PARENT_RIGHT;
import static android.widget.RelativeLayout.ALIGN_PARENT_TOP;
import static android.widget.RelativeLayout.CENTER_IN_PARENT;
import static com.ons.android.ONSMessagingWebViewJavascriptBridge.DevelopmentErrorCause;
...
import com.ons.android.messaging.css.DOMNode;
import com.ons.android.messaging.css.Document;
import com.ons.android.messaging.model.MessagingError;
import com.ons.android.messaging.model.WebViewMessage;
import com.ons.android.messaging.view.AnimatedCloseButton;
import com.ons.android.messaging.view.helper.StyleHelper;
import com.ons.android.messaging.view.helper.ThemeHelper;
import com.ons.android.messaging.view.helper.ViewCompat;
import com.ons.android.messaging.view.styled.WebView;
...
public class WebFormatView extends FrameLayout {
    ...
    public WebFormatView(
        ...
        @NonNull ONSMessagingWebViewJavascriptBridge jsInterface
    ) {
        super(context);
        setId(R.id.com_onssdk_messaging_root_view);
        ...
        webView.addJavascriptInterface(jsInterface, "_onsAndroidBridge");
        webView.setWebChromeClient(
            new WebChromeClient() {
                ...
                public void onCloseWindow(android.webkit.WebView window) {
                    ...
                    if (window.getId() == R.id.com_onssdk_messaging_web_view) {
                        dismissMessage();
                    }
                }
        ...
        webView.setWebViewClient(
            new WebViewClient() {
                ...
                public void onONSPageStartedDrawing() {
                    timeoutDone = true;
    ...
    public void startLoading() {
        ...
        final String language = ONS.User.getLanguage(this.getContext());
        final String region = ONS.User.getRegion(this.getContext());

        if (!TextUtils.isEmpty(language)) {
            headers.put("X-ONS-Custom-Language", language);
        }

        if (!TextUtils.isEmpty(region)) {
            headers.put("X-ONS-Custom-Region", language);
        }
    ...
    private RelativeLayout addRootContainerView() {
        ...
        rootContainer.setId(R.id.com_onssdk_messaging_container_view);
    ...
    private WebView addWebView(@NonNull RelativeLayout container) {
        ...
        webView.setId(R.id.com_onssdk_messaging_web_view);
    ...
    private AnimatedCloseButton addCloseButton(@NonNull RelativeLayout container) {
        ...
        closeButton.setId(R.id.com_onssdk_messaging_close_button);
