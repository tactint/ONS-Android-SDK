...
import com.ons.android.messaging.ModalContentPanGestureDetector;
...
import com.ons.android.messaging.view.formats.BannerView;
...
public class ModalTemplateFragment
    ...
    public static ModalTemplateFragment newInstance(ONSMessage payloadMessage, ModalMessage messageModel) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(
            STYLE_NO_FRAME,
            showStatusbar ? R.style.com_onssdk_ModalDialogTheme : R.style.com_onssdk_ModalDialogTheme_Fullscreen
        );
