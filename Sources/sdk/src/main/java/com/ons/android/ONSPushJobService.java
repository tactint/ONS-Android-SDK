...
/**
 * JobService implementation of ONS Push
 */

@RequiresApi(api = Build.VERSION_CODES.O)
@PublicSDK
public class ONSPushJobService extends JobService {

    private static final String TAG = "ONSPushJobService";

    public static final String JOB_EXTRA_PUSH_DATA_KEY = "com.ons.push_data";
    ...
    private static class PresentPushTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ONSPushNotificationPresenter.displayForPush(unwrappedService, pushData);
