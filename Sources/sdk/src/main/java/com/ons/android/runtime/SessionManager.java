...
import com.ons.android.localcampaigns.LocalCampaignsTracker;
...
public class SessionManager implements ComponentCallbacks2, Application.ActivityLifecycleCallbacks {
    ...
    private static final String TAG = "ONSSessionManager";
    ...
    protected boolean areAllActivitiesDestroyed() {
        ...
        if (count < 0) {
            Logger.error(
                TAG,
                "ONS's Activity create counter is < 0. Something went wrong at some point with the activity lifecycles."
            );
