...
import com.ons.android.messaging.view.DelegatedTouchEventViewGroup;
import com.ons.android.messaging.view.FixedRatioFrameLayout;
...
public class ImageFormatView extends FrameLayout implements AsyncImageDownloadTask.ImageDownloadListener {
    ...
    private void addBackgroundView() {
        ...
        backgroundView.setId(R.id.com_onssdk_messaging_background_view);
    ...
    private ImageContainerView addImageContainer(@NonNull RelativeLayout container) {
        ...
        imageContainer.setId(R.id.com_onssdk_messaging_image_container_view);
