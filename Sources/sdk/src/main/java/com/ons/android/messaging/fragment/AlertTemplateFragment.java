...
public class AlertTemplateFragment extends BaseDialogFragment<AlertMessage> {
    ...
    public static AlertTemplateFragment newInstance(ONSMessage payloadMessage, AlertMessage messageModel) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (message == null) {
            Logger.error(
                TAG,
                "Unknown error while creating alert fragment. Please report this to ONS's support. (code -3)"
            );
        ...
        if (context == null) {
            Logger.error(
                TAG,
                "Unknown error while creating alert fragment. Please report this to ONS's support. (code -5)"
            );
            return super.onCreateDialog(savedInstanceState);
        }
