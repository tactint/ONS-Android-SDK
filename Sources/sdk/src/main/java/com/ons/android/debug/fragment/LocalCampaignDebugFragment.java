...
public class LocalCampaignDebugFragment extends Fragment implements View.OnClickListener {
    ...
    private String formatDate(ONSDate date) {
        DateFormat df = new SimpleDateFormat(getString(R.string.com_onssdk_debug_date_format), Locale.US);
        return df.format(new Date(date.getTime()));
    }

    private String getShareString(LocalCampaign campaign) {
        String shareContent = "ONS SDK - In-App Campaign:\n";
        ...
        if (campaign.publicToken != null) {
            shareContent =
                shareContent.concat(
                    String.format(
                        "%s: %s\n",
                        getString(R.string.com_onssdk_local_campaign_debug_fragment_token),
            ...
            shareContent =
                shareContent.concat(
                    String.format(
                        "%s: %s\n",
                        getString(R.string.com_onssdk_local_campaign_debug_fragment_token),
                        getString(R.string.com_onssdk_debug_view_empty)
                    )
                );
        }
        ...
        if (campaign.startDate != null) {
            shareContent =
                shareContent.concat(
                    String.format(
                        "%s: %s\n",
                        getString(R.string.com_onssdk_local_campaign_debug_fragment_start_date),
        ...
        if (campaign.endDate != null) {
            shareContent =
                shareContent.concat(
                    String.format(
                        "%s: %s\n",
                        getString(R.string.com_onssdk_local_campaign_debug_fragment_end_date),
            ...
            shareContent =
                shareContent.concat(
                    String.format(
                        Locale.US,
                        "%s: %d\n",
                        getString(R.string.com_onssdk_local_campaign_debug_fragment_capping),
                        campaign.capping
                    )
                );
        } else {
        ...
        shareContent =
            shareContent.concat(
                String.format(
                    Locale.US,
                    "%s: %d\n",
                    getString(R.string.com_onssdk_local_campaign_debug_fragment_period),
        ...
        if (!campaign.triggers.isEmpty()) {
            ...
            shareContent =
                shareContent.concat(
                    String.format(
                        "%s: %s\n",
                        getString(R.string.com_onssdk_local_campaign_debug_fragment_trigger),
                        triggers.toString()
                    )
                );
        } else {
    ...
    private void displayCampaign(LocalCampaign campaign) {
        if (campaign.publicToken != null) {
            ...
            token.setText(R.string.com_onssdk_debug_view_empty);
        }

        if (campaign.startDate != null) {
            startDate.setText(formatDate(campaign.startDate));
        } else {
            startDate.setText(R.string.com_onssdk_debug_view_empty);
        }

        if (campaign.endDate != null) {
            endDate.setText(formatDate(campaign.endDate));
        } else {
            endDate.setText(R.string.com_onssdk_debug_view_empty);
        }

        if (campaign.capping != null) {
            capping.setText(String.format(Locale.US, "%d", campaign.capping));
        } else {
            capping.setText(R.string.com_onssdk_debug_view_empty);
        }
        ...
        if (!campaign.triggers.isEmpty()) {
            ...
            trigger.setText(R.string.com_onssdk_debug_view_empty);
        }
    }
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.com_onssdk_local_campaign_debug_fragment, container, false);
        token = view.findViewById(R.id.com_onssdk_local_campaign_debug_fragment_token);
        startDate = view.findViewById(R.id.com_onssdk_local_campaign_debug_fragment_start_date);
        endDate = view.findViewById(R.id.com_onssdk_local_campaign_debug_fragment_end_date);
        capping = view.findViewById(R.id.com_onssdk_local_campaign_debug_fragment_capping);
        gracePeriod = view.findViewById(R.id.com_onssdk_local_campaign_debug_fragment_period);
        trigger = view.findViewById(R.id.com_onssdk_local_campaign_debug_fragment_trigger);
        View shareButton = view.findViewById(R.id.com_onssdk_identifier_debug_fragment_share_button);
    ...
    public void onClick(View v) {
        ...
        if (campaign != null) {
            ...
            sharingIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.com_onssdk_debug_view_title));
            sharingIntent.putExtra(Intent.EXTRA_TEXT, shareContent);
            startActivity(Intent.createChooser(sharingIntent, getString(R.string.com_onssdk_debug_view_share)));
        }
    }
}
