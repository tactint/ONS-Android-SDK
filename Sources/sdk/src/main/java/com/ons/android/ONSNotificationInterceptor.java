 ...
 * <p>
 * An interceptor's job is to override some aspects of a notification that ONS wants to display.
...
public abstract class ONSNotificationInterceptor {
     ...
     * If you're basing your builder on defaultBuilder, some methods might have undefined behaviour as ONS already calls many of them.<br/>
     ...
     * @param defaultBuilder   NotificationCompat builder that has been created and fully configured by ONS.
     * @param pushIntentExtras Raw push intent extras. Read directly your custom payload values from the extras as string values, or use {@link ONSPushPayload#payloadFromReceiverExtras(Bundle)} to extract ONS data from the extras.
     ...
     *
     * @param context          Context. Will usually be a service context.
     * @param defaultId        Notification Id that was generated and about to be used by ONS
     * @param pushIntentExtras Raw push intent extras. Read directly your custom payload values from the extras as string values, or use {@link ONSPushPayload#payloadFromReceiverExtras(Bundle)} to extract ONS data from the intent.
