...
public class DispatcherSerializer {
     ...
     */
    @NonNull
    public static JSONObject serialize(@NonNull Set<ONSEventDispatcher> dispatchers) {
        JSONObject json = new JSONObject();
        for (ONSEventDispatcher dispatcher : dispatchers) {
            try {
