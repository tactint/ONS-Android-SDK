package com.ons.android.debug.adapter;
...
public class CollectionAdapter extends BaseAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            view = inflater.inflate(R.layout.com_onssdk_user_data_debug_collection_item, parent, false);
        } else {
            view = convertView;
        }

        collectionName = view.findViewById(R.id.com_onssdk_user_data_debug_collection_name);
        tagList = view.findViewById(R.id.com_onssdk_user_data_debug_tag_list);
