...
/**
 * ONSNotificationChannelsManager manages how ONS interacts with Android 8.0 (API 26).
 * It allows you to control which default notification channel ONS will use, how it is named, or
...
public final class ONSNotificationChannelsManager {
    ...
    private ONSNotificationChannelsManager(PushModule pushModule) {
        this.pushModule = pushModule;
    }

    @Provide
    public static ONSNotificationChannelsManager provide() {
        return new ONSNotificationChannelsManager(PushModuleProvider.get());
    }
    ...
    @NonNull
    String getChannelId(@Nullable ONSPushPayload payload) {
    ...
    void registerONSChannelIfNeeded(Context c) {
        if (isChannelIdOverridden()) {
            Logger.internal(PushModule.TAG, "Channel ID overridden, not registering ONS's channel.");
            return;
        }
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            Logger.internal(PushModule.TAG, "Registering default ONS notification channel");
            //try {
            ...
            /*
				...
				Logger.error(PushModule.TAG, "Could not register ONS's notification channel to Android. Notifications might not be displayed.", e);
			}*/
        }
    }

    String getONSChannelName() {
        String name = null;
    ...
    /**
     * Overrides the default notification channel that ONS will use for notifications.<br/>
     * By default, ONS will manage its own channel, identified by {@link #DEFAULT_CHANNEL_ID}.<br/>
     * After calling this method with a non-null channelId, ONS will stop trying to register its default channel
     * <p>
    ...
    /**
     * Used to set a channel name provider, allowing you to change ONS's default channel name.<br/>
     * <p>
     * This is the string that the user will see in their device settings, so you should translate it.<br/>
     * ONS will call you back on your provider at least once, to get the channel name, and then will
     * call you on every locale change, to make sure that the Android OS has the right translation.<br/><br/>
     * <p>
     * If your provider throws an exception, ONS will use its default name.<br/><br/>
     * <p>
     * If you simply want to use a string resource, use {@link #setChannelName(Context, int)}.<br/>
     * <p>
     * Set to 'null' to remove the provider and use ONS's default one.<br/>
     */
     ...
     * You will be called on this interceptor before displaying notifications, unless you're in manual mode and don't use ONS to display the notification.<br/><br/>
     * <p>
     * The provider might be called on ANY API Level<br/><br/>
     * <p>
     * If your provider throws an exception, ONS will use its default name.<br/>
     */
    ...
    /**
     * Opens the notification channel settings system UI for ONS's default channel.
     * <p>
     ...
     * <p>
     * Implementing that interface allows ONS to call you back on locale change, to update your
    ...
    public interface ChannelNameProvider {
         ...
         * If this method throws an exception, ONS will use its default name.
         */
        @NonNull
    ...
    /**
     * Interface describing a channel ID interceptor for notifications displayed by ONS
     */
    @PublicSDK
    public interface NotificationChannelIdInterceptor {
         ...
         * <p>
         * If this method throws an exception, ONS will use the value of deductedChannelId.
         *
         * @param payload           Full push payload. Read your custom payload as string values, using {@link Bundle#getString(String)} on {@link ONSPushPayload#getPushBundle()}
         ...
         */
        @Nullable
        String getChannelId(@NonNull ONSPushPayload payload, String deductedChannelId);
    }
}
