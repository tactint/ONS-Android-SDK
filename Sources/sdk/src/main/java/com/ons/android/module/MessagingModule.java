...
import com.ons.android.ONS.Messaging;
import com.ons.android.ONSBannerView;
import com.ons.android.ONSBannerViewPrivateHelper;
import com.ons.android.ONSInAppMessage;
import com.ons.android.ONSLandingMessage;
import com.ons.android.ONSMessage;
import com.ons.android.ONSMessageAction;
import com.ons.android.ONSMessageCTA;
import com.ons.android.ONSMessagingException;
import com.ons.android.MessagingActivity;
...
import com.ons.android.di.providers.MessagingAnalyticsDelegateProvider;
...
import com.ons.android.messaging.fragment.AlertTemplateFragment;
import com.ons.android.messaging.fragment.ImageTemplateFragment;
import com.ons.android.messaging.fragment.ModalTemplateFragment;
import com.ons.android.messaging.fragment.UniversalTemplateFragment;
import com.ons.android.messaging.fragment.WebViewTemplateFragment;
...
import com.ons.android.messaging.view.styled.TextView;
...
/**
 * ONS's Messaging Module.
 *
 */
@Module
@Singleton
public class MessagingModule extends ONSModule {
     ...
     */
    public static final String ACTION_DISMISS_INTERSTITIAL = "com.ons.android.messaging.DISMISS_INTERSTITIAL";

    /**
     * Broadcast this action using {@link LocalBroadcastManager} and banners will dismiss themselves
     */
    public static final String ACTION_DISMISS_BANNER = "com.ons.android.messaging.DISMISS_BANNER";
    ...
    private ONSMessage pendingMessage = null;
    ...
    @Nullable
    public ONSMessage popPendingMessage() {
        ONSMessage retVal = pendingMessage;
        pendingMessage = null;
        return retVal;
    }
    ...
    public boolean doesAppHaveRequiredLibraries(boolean logErrors) {
        if (!ReflectionHelper.isAndroidXFragmentPresent()) {
            if (logErrors) {
                Logger.error(
                    TAG,
                    "Your app doesn't seem to have the android X fragment library, or its version is lower than the 1.0.0 minimum required by ONS.. The landing will not be displayed. More info at https://pfs.gdn/doc ."
                );
            }
            return false;
        }
        ...
        if (!ReflectionHelper.isAndroidXAppCompatActivityPresent()) {
            if (logErrors) {
                Logger.error(
                    TAG,
                    "Your app doesn't seem to have the android X appcompat library, or its version is lower than the 1.0.0 minimum required by ONS. The landing will not be displayed. More info at https://pfs.gdn/doc ."
                );
            }
            return false;
        }
    ...
    public DialogFragment loadFragment(
        ...
        @NonNull ONSMessage payloadMessage,
        ...
        if (!doesAppHaveRequiredLibraries(true)) {
            throw new ONSMessagingException(
        ...
        try {
            ...
            if (payloadMessage instanceof ONSInAppMessage) {
                message.source = Message.Source.LOCAL;
            } else if (payloadMessage instanceof ONSLandingMessage) {
                if (((ONSLandingMessage) payloadMessage).isDisplayedFromInbox()) {
            ...
            throw new ONSMessagingException(e.getMessage());
        }
        ...
        if (message instanceof AlertMessage) {
            ...
            throw new ONSMessagingException("Internal error (code 10)");
        }
    }

    public ONSBannerView loadBanner(
        @NonNull Context context,
        @NonNull ONSMessage payloadMessage,
        @NonNull JSONObject json
    ) throws ONSMessagingException {
        ...
        if (message instanceof BannerMessage) {
            return ONSBannerViewPrivateHelper.newInstance(
                payloadMessage,
                (BannerMessage) message,
                MessagingAnalyticsDelegateProvider.get(message, payloadMessage)
            );
        } else {
            throw new ONSMessagingException("The ONSMessage instance does not represent a banner.");
        }
    }

    public void performAction(Context c, ONSMessage payloadMessage, Action a) {
        if (!TextUtils.isEmpty(a.action)) {
            actionModule.performAction(c, a.action, a.args, payloadMessage);
        }
    }

    public void displayMessage(@NonNull Context context, @NonNull ONSMessage message, boolean bypassDnD) {
        ...
        try {
            ONSBannerView banner = ONS.Messaging.loadBanner(context, message);
    ...
    public void displayInAppMessage(@NonNull ONSInAppMessage message) {
        ...
        if (presentedActivity != null) {
            ...
            if (listener instanceof Messaging.LifecycleListener2) {
                shouldDisplayMessage = !((Messaging.LifecycleListener2) listener).onONSInAppMessageReady(message);
            }
    ...
    public void onMessageShown(@NonNull Message message) {
        ...
        if (listener != null) {
            listener.onONSMessageShown(message.devTrackingIdentifier);
        }
    }
    ...
    public void onMessageDismissed(@NonNull Message message) {
        ...
        if (listener != null) {
            listener.onONSMessageClosed(message.devTrackingIdentifier);
        }
    }
    ...
    public void onMessageClosed(@NonNull Message message) {
        ...
        if (listener != null) {
            listener.onONSMessageCancelledByUser(message.devTrackingIdentifier);
        }
    }
    ...
    public void onMessageCTAClicked(@NonNull Message message, int ctaIndex, @NonNull CTA cta) {
        ...
        if (listener != null) {
            listener.onONSMessageActionTriggered(message.devTrackingIdentifier, ctaIndex, new ONSMessageCTA(cta));
        }
    }
    ...
    public void onWebViewMessageClickTracked(
        ...
        if (listener != null) {
            listener.onONSMessageWebViewActionTriggered(
                message.devTrackingIdentifier,
                buttonAnalyticsId,
                new ONSMessageAction(action)
            );
        }
    }
    ...
    public void onMessageGlobalTap(@NonNull Message message, @NonNull Action action) {
        ...
        if (listener != null) {
            listener.onONSMessageActionTriggered(
                message.devTrackingIdentifier,
    ...
    public void onMessageAutoClosed(@NonNull Message message) {
        ...
        if (listener != null) {
            listener.onONSMessageCancelledByAutoclose(message.devTrackingIdentifier);
        }
    }
    ...
    public void onMessageClosedError(@NonNull Message message, @NonNull MessagingError cause) {
        ...
        if (listener != null) {
            listener.onONSMessageCancelledByError(message.devTrackingIdentifier);
        }
    }
    //endregion
}
