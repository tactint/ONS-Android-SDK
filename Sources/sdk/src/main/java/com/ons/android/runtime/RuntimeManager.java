...
public class RuntimeManager {
    ...
    /**
     * Date of when ONS was last started by a service WITH userActivity = true (or an Activity)
    ...
    /**
     * Execute an action to read the ons configuration
    ...
    /**
     * Execute an action to update the ons configuration.
    ...
    /**
     * Run this action if ONS is ready
     *
    ...
    /**
     * Run this action if ONS is at the given wanted state
     *
     * @param wantedState The state we want
    ...
    /**
     * Decrement the number of services retaining ONS.
     */
    ...
    public boolean isRetainedByService() {
        ...
        if (refCount < 0) {
            Logger.error(
                TAG,
                "ONS has been under-locked. You probably called ONS.onServiceDestroy() too many times. Recovering, but this may leave ONS in an undesired state."
            );
    ...
    /**
     * Set the last time the ONS was started for user activity to now.
    ...
    /**
     * Get the last time ONS was started for user activity.
     *
            ...
            if (simulateActivityStart) {
                ...
                if (activity != null) {
                    ...
                    Logger.error(
                        ...
                        " This should not happen. Sessions will NOT be tracked correctly. Please report this to ONS's support."
                    );
                }
            }
        }
