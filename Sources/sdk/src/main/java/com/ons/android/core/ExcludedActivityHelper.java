...
/**
 * Simple helper class to check if an activity should be excluded from the ONS's lifecycle
...
public class ExcludedActivityHelper {
    ...
    /**
     * Meta-data name to tag an activity excluded from ONS
     */
    private static final String EXCLUDED_ACTIVITY_META_DATA = "com.ons.android.EXCLUDE_FROM_LIFECYCLE";
    ...
    /**
     * Check if the activity has a ONS push payload and saving it.
     *
     ...
     * @return true if the activity should be excluded from ONS
     */
