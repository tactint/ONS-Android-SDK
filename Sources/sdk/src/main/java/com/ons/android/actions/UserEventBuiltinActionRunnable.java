...
public class UserEventBuiltinActionRunnable implements UserActionRunnable {
    ...
    public void performAction(
        ...
        try {
            ...
            ONSEventAttributes data = new ONSEventAttributes();
            String label = json.reallyOptString("l", null);
            if (label != null) {
                data.put(ONSEventAttributes.LABEL_KEY, label);
            }
            ...
            if (jsonTags != null && jsonTags.length() > 0) {
                ...
                data.putStringList(ONSEventAttributes.TAGS_KEY, tags);
            }
            ...
            ONS.Profile.trackEvent(event, data);
