...
public class DataCollectionUtils {
    ...
    /**
     * Method to compare two ons privacy data config.
     * <p>
    ...
    public static boolean areConfigsEquals(
        @NonNull ONSDataCollectionConfig config,
        @NonNull ONSDataCollectionConfig config2
    ) {
