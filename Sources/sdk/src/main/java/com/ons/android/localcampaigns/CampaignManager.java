...
import static com.ons.android.localcampaigns.model.LocalCampaign.SyncedJITResult;
...
import com.ons.android.core.DateProvider;
import com.ons.android.core.Logger;
import com.ons.android.core.Parameters;
import com.ons.android.core.SystemDateProvider;
...
import com.ons.android.localcampaigns.persistence.LocalCampaignsFilePersistence;
import com.ons.android.localcampaigns.persistence.LocalCampaignsPersistence;
import com.ons.android.localcampaigns.persistence.PersistenceException;
...
import com.ons.android.query.serialization.deserializers.LocalCampaignsResponseDeserializer;
import com.ons.android.query.serialization.serializers.LocalCampaignsResponseSerializer;
 ...
 * - Automatically if in auto mode (if dev didn't ask ONS to delay campaigns)
...
public class CampaignManager {
    ...
    private static final String PERSISTENCE_LOCAL_CAMPAIGNS_FILE_NAME = "com.ons.localcampaigns.persist.json";
    ...
    public List<LocalCampaign> cleanCampaignList(@NonNull List<LocalCampaign> campaignsToClean) {
        final ONSDate currentDate = dateProvider.getCurrentDate();
    ...
    protected boolean isCampaignDisplayable(LocalCampaign campaign) {
        ONSDate currentDate = dateProvider.getCurrentDate();
    ...
    public void openViewTracker() {
        if (viewTracker != null) {
            ...
            if (context != null && !viewTracker.isOpen()) {
                ...
                // ONSModule#onsDidStart javadoc lied
            }
        }
    }
