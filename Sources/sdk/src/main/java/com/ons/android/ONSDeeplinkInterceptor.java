 ...
 * An interceptor's job is to override some aspects of a deeplink that ONS wants to open.
...
public interface ONSDeeplinkInterceptor {
    ...
    /**
     * Called when a deeplink is triggered by ONS (only called from a push notification).
     * If null is returned {@link ONSDeeplinkInterceptor#getIntent(Context, String)} will be used.
     * <p>
    ...
    /**
     * Called when a deeplink is triggered by ONS (could be from a push notification or an in-app message).
