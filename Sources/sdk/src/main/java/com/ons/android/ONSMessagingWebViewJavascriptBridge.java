...
public class ONSMessagingWebViewJavascriptBridge {
    ...
    private static final String TAG = "ONSWebviewJSInterface";

    private final Context applicationContext;
    private final ONSMessage message;
    private final WebViewActionListener actionListener;

    public ONSMessagingWebViewJavascriptBridge(
    ...
    protected String getInstallationID() {
        return ONS.User.getInstallationID();
    }

    @VisibleForTesting
    @Nullable
    protected String getCustomLanguage() {
        return ONS.User.getLanguage(applicationContext);
    }

    @VisibleForTesting
    @Nullable
    protected String getCustomRegion() {
        return ONS.User.getRegion(applicationContext);
    }

    @VisibleForTesting
    @Nullable
    protected String getCustomUserID() {
        return ONS.User.getIdentifier(applicationContext);
    }
