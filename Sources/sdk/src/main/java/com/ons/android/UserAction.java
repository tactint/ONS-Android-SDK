...
/**
 * Model that represents an user action, which can be triggered by ONS SDK in various contexts.
 */
@PublicSDK
public class UserAction {
     ...
     * @param runnable   The {@link UserActionRunnable} that will be executed when ONS needs to perform your action.
     */
