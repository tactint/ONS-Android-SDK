...
//
package com.ons.android.msgpack.core.buffer;

import static com.ons.android.msgpack.core.Preconditions.checkArgument;
...
public class MessageBuffer {
    ...
    private static final String UNIVERSAL_MESSAGE_BUFFER = "com.ons.android.msgpack.core.buffer.MessageBufferU";
    private static final String BIGENDIAN_MESSAGE_BUFFER = "com.ons.android.msgpack.core.buffer.MessageBufferBE";
    private static final String DEFAULT_MESSAGE_BUFFER = "com.ons.android.msgpack.core.buffer.MessageBuffer";
    ...
    static {
        ...
        try {
            ...
            // Detect android VM
            boolean isAndroid = System.getProperty("java.runtime.name", "").toLowerCase(Locale.US).contains("android");
