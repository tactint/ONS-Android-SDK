 ...
 * <p>
 * Internal logs can be enabled using setprop  log.tag.ONSInternal VERBOSE
 *
 */
public final class Logger {
     ...
     * Public logger tag.
     */
    public static final String PUBLIC_TAG = "ONS";

    /**
     * Internal logger tag.
     */
    public static final String INTERNAL_TAG = "ONSInternal";
