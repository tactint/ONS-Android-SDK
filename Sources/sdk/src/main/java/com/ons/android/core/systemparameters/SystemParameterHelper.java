package com.ons.android.core.systemparameters;
...
public final class SystemParameterHelper {
    ...
    /**
     * Get the version of the Bridge currently using ONS if available
     *
    ...
    /**
     * Get the version of the Plugin currently using ONS if available
     *
    ...
    /**
     * Get the ons sdk api level
     * @return The ons sdk api level
     */
    ...
    /**
     * Get the ons sdk messaging api level
     * @return The ons sdk messaging api level
     */
