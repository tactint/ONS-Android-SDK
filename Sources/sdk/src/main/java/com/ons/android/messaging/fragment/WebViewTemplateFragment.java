...
import com.ons.android.messaging.WebViewHelper;
import com.ons.android.messaging.css.CSSParsingException;
import com.ons.android.messaging.css.DOMNode;
import com.ons.android.messaging.css.Document;
import com.ons.android.messaging.css.Parser;
import com.ons.android.messaging.css.builtin.BuiltinStyleProvider;
...
import com.ons.android.messaging.view.formats.WebFormatView;
...
public class WebViewTemplateFragment
    ...
    public static WebViewTemplateFragment newInstance(ONSMessage payloadMessage, WebViewMessage messageModel) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_FRAME, R.style.com_onssdk_WebViewDialogTheme);
    }
    ...
    private View getWebFormatView(Context context) {
        ...
        final ONSMessagingWebViewJavascriptBridge jsInterface = new ONSMessagingWebViewJavascriptBridge(
            context,
            getPayloadMessage(),
            this
        );
    ...
    public void onDismissAction(@Nullable String analyticsID) {
        onPerformAction("ons.dismiss", new JSONObject(), analyticsID);
    }
