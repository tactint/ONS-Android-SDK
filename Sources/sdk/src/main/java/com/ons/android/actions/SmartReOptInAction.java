...
import static com.ons.android.core.NotificationPermissionHelper.PERMISSION_NOTIFICATION;
...
public class SmartReOptInAction extends BroadcastReceiver implements UserActionRunnable {
    ...
    public void performAction(
        ...
        // If yes redirect to settings else request permission by creating ons channel
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (PERMISSION_NOTIFICATION.equals(permission)) {
            ...
            boolean shouldRedirectSettings = intent.getBooleanExtra(
                ONSPermissionActivity.EXTRA_REDIRECT_SETTINGS,
                false
            );
