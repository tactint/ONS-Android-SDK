...
public class InboxNotificationContentInternalTest {
    ...
    private String payloadJson =
        "{\"t\":\"c\",\"l\":\"https://pfs.gdn\",\"i\":\"79946434-e5c3-4b22-1a1a-68e8f556740a\",\"od\":{\"n\":\"02521fa3e-70e4-11ea-b5ac-bf057dd56464\",\"ct\":\"2918f6a1d46ff48c9e74bfded5d5d9c9e\"}}";
    ...
    public void testValidPayload() {
        ...
        Assert.assertEquals(payloadBundle.getString("com.ons"), payloadJson);
    ...
    public void testInvalidPayload() {
        ...
        content = new InboxNotificationContentInternal(ONSNotificationSource.CAMPAIGN, null, payload, identifiers);
        Assert.assertFalse(content.isValid());

        content = new InboxNotificationContentInternal(ONSNotificationSource.CAMPAIGN, now, null, identifiers);
        Assert.assertFalse(content.isValid());

        content = new InboxNotificationContentInternal(ONSNotificationSource.CAMPAIGN, now, payload, null);
        Assert.assertFalse(content.isValid());
    }
}
