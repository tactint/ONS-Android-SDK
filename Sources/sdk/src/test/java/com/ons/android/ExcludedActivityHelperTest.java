...
public class ExcludedActivityHelperTest {
    ...
    public void setUp() throws NoSuchFieldException {
        ...
        // Adding ons mocked payload to the activity
        final Bundle payload = new Bundle();
        payload.putString("com.ons", "{l:'ons payload'}");
        final Bundle extras = new Bundle();
        extras.putBundle(ONS.Push.PAYLOAD_KEY, payload);
    ...
    /**
     * Test the helper for an activity which should be excluded from ons
     */
    @Test
    public void testActivityIsExcluded() {
        // Testing the activity ignore ons
    ...
    /**
     * Test the helper for an activity which should not be excluded from ons
     */
    @Test
