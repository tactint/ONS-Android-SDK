package com.ons.android.profile

import androidx.test.filters.SmallTest
import com.ons.android.ONSEmailSubscriptionState
...
class ProfileDataSerializerTest {
    ...
    fun testSerialize() {
        ...
        val dataModel = ProfileUpdateOperation().apply {
            setEmail("test@pfs.gdn")
            setLanguage("fr")
            setRegion("FR")
            setEmailMarketing(ONSEmailSubscriptionState.SUBSCRIBED)
            ...
            addAttribute("url_att", UserAttribute(URI("https://pfs.gdn/pricing"), AttributeType.URL))
        ...
        Assert.assertEquals("test@pfs.gdn", actual.getString("email"))
        ...
        Assert.assertEquals("https://pfs.gdn/pricing", actualCustomAttributes.getString("url_att.u"))
