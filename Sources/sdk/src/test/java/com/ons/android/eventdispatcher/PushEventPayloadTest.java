...
public class PushEventPayloadTest {
    ...
    public void testValidData() {
        String stringPayload =
            "{\"google.delivered_priority\":\"high\",\"google.sent_time\":1569598588132,\"google.ttl\":2419200,\"google.original_priority\":\"high\",\"msg\":\"test swag transac 4\",\"from\":\"519597932539\",\"title\":\"test Transac #4\",\"google.message_id\":\"0:1569598588136037%1e91dabb5c13d641\",\"com.ons\":\"{\\\"t\\\":\\\"t\\\",\\\"od\\\":{\\\"n\\\":\\\"925a4e70-e13c-11e9-bbd4-cf7d44429d5e\\\"},\\\"i\\\":\\\"Testtransac4-1569598588\\\",\\\"l\\\":\\\"https://pfs.gdn/test?utm_campaign=test&utm_content=content-id-1\\\"}\",\"collapse_key\":\"default\",\"utm_source\":\"salkutsaut\"}";
        Bundle payload = jsonStringToBundle(stringPayload);

        Assert.assertNotNull(payload);

        ONSPushPayload pushPayload = null;
        try {
            pushPayload = ONSPushPayload.payloadFromReceiverExtras(payload);
        ...
        Assert.assertEquals(
            ...
            "https://pfs.gdn/test?utm_campaign=test&utm_content=content-id-1"
        );
        Assert.assertNull(eventPayload.getTrackingId());
        Assert.assertEquals(eventPayload.getCustomValue("utm_source"), "salkutsaut");
        Assert.assertNull(eventPayload.getCustomValue("com.ons"));
