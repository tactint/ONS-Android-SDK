...
public class ProfileDataHelperTest {
    ...
    public void testIsNotValidEmail() {
        // Valid use case
        Assert.assertFalse(ProfileDataHelper.isNotValidEmail("foo@pfs.gdn"));
        Assert.assertFalse(ProfileDataHelper.isNotValidEmail("bar@foo.pfs.gdn"));
        Assert.assertFalse(ProfileDataHelper.isNotValidEmail("bar+foo@pfs.gdn"));
        Assert.assertFalse(ProfileDataHelper.isNotValidEmail("FOObar@Test.ONS.COM"));
