...
import com.ons.android.messaging.model.BaseBannerMessage;
...
public class PayloadParserTest {
    ...
    public void testImagePayload() throws PayloadParsingException, JSONException {
        String payload =
            "{'image':'https://static.pfs.gdn/tmp/test_inapp.jpg','hasImage':true,'kind':'image','id':'tmpid','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'style':'@import sdk(\\\"image1-detached\\\");'}";
        JSONObject json = new JSONObject(payload);

        Message message = PayloadParser.parsePayload(json);
        Assert.assertTrue(message instanceof ImageMessage);
        ImageMessage imageMessage = (ImageMessage) message;
        Assert.assertEquals("https://static.pfs.gdn/tmp/test_inapp.jpg", imageMessage.imageURL);
        Assert.assertEquals("ons.deeplink", imageMessage.globalTapAction.action);
    ...
    public void testImageNoImagePayload() throws JSONException {
        String payload =
            "{'hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'style':'@import sdk(\\\"image1-detached\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testImageNoStylePayload() throws JSONException {
        String payload =
            "{'image':'https://static.pfs.gdn/tmp/test_inapp.jpg','hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}}}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testImageInvalidStylePayload() throws JSONException {
        String payload =
            "{'image':'https://static.pfs.gdn/tmp/test_inapp.jpg','hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'style':'wrong-cs;s;sd'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testImageNegativeDimensionsPayload() throws JSONException {
        String payload =
            "{'image':'https://static.pfs.gdn/tmp/test_inapp.jpg','width':-1,'height':-1,'hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'style':'@import sdk(\\\"image1-detached\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testWebViewPayload() throws PayloadParsingException, JSONException {
        String payload =
            "{'url':'https://ons-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
        JSONObject json = new JSONObject(payload);

        Message message = PayloadParser.parsePayload(json);
        Assert.assertTrue(message instanceof WebViewMessage);
        WebViewMessage webViewMessage = (WebViewMessage) message;
        Assert.assertEquals("https://ons-html-inapp-test.glitch.me/index.html", webViewMessage.url);
    ...
    public void testWebViewNoStylePayload() throws JSONException {
        String payload =
            "{'url':'https://ons-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testWebViewInvalidStylePayload() throws JSONException {
        String payload =
            "{'url':'https://ons-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest', 'style':'pdigr;sefs'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testModalPayload() throws PayloadParsingException, JSONException {
        String payload =
            "{'cta':[{'l':'testLabel', 'a': 'ons.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'kind':'modal','close':true,'cta_direction':'h','auto_close':0,'style':'@import sdk(\\\"modal1\\\");'}";
        JSONObject json = new JSONObject(payload);
        ...
        Assert.assertEquals("ons.deeplink", modalMessage.globalTapAction.action);
        ...
        Assert.assertEquals("ons.deeplink", modalMessage.ctas.get(0).action);
    }

    @Test
    public void testModalNoStylePayload() throws JSONException {
        String payload =
            "{'cta':[{'l':'testLabel', 'a': 'ons.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'kind':'modal','close':true,'cta_direction':'h','auto_close':0}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testModalInvalidStylePayload() throws JSONException {
        String payload =
            "{'cta':[{'l':'testLabel', 'a': 'ons.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'kind':'modal','close':true,'cta_direction':'h','auto_close':0, 'style':'sefs;sef;s'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testBannerPayload() throws PayloadParsingException, JSONException {
        String payload =
            "{'cta':[{'l':'testLabel', 'a': 'ons.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'ons.deeplink','args':{'l':'https://google.fr'}},'kind':'banner','close':true,'cta_direction':'h','auto_close':0,'style':'@import sdk(\\\"banner1\\\");'}";
        JSONObject json = new JSONObject(payload);
        ...
        Assert.assertEquals("ons.deeplink", bannerMessage.globalTapAction.action);
        ...
        Assert.assertEquals("ons.deeplink", bannerMessage.ctas.get(0).action);
    }

    @Test
    public void testUniversalPayload() throws PayloadParsingException, JSONException {
        String payload =
            "{'cta':[{'l':'testLabel', 'a': 'ons.deeplink','args':{'l':'https://google.fr'}}],'id':'tmpid','did':'webtest','ctaCount':1,'hasImage':false,'kind':'universal','flip_hero_h':false,'flip_hero_v':true,'attach_cta_bottom':true,'stack_cta_h':false,'stretch_cta_h':true,'hero_split_ratio':0.4,'close':false,'style':'@import sdk(\\\"generic1-v-cta\\\");'}";
        JSONObject json = new JSONObject(payload);
        ...
        Assert.assertEquals("ons.deeplink", universalMessage.ctas.get(0).action);
    }
    ...
    public void testMinimumAndroidVersion() throws PayloadParsingException, JSONException {
        // Recent enough
        String payload =
            "{'min_android_sdk': 26, 'url':'https://ons-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
        JSONObject json = new JSONObject(payload);
