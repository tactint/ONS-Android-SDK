...
public class ONSUserStartTest
{
    ...
    public void testCustomDataBeforeStart()
    {
        ...
        ONSUserDataEditor editor = ONS.User.editor();
        ...
        assertEquals("jesuisuntest", ONS.User.getIdentifier(context));
        assertEquals("FR", ONS.User.getRegion(context));
        assertEquals("fr-FR", ONS.User.getLanguage(context));

        TestUtils.closeScenario(scenario);

        editor = ONS.User.editor();
    ...
    public void testAttributesBeforeStart()
    {
        ...
        listener = new MockONSAttributesFetchListener();
        UserDataAccessor.fetchAttributes(context, listener, false);
    ...
    public void testTagCollectionsBeforeStart()
    {
        ...
        listener = new MockONSTagCollectionsFetchListener();
        UserDataAccessor.fetchTagCollections(context, listener, false);
