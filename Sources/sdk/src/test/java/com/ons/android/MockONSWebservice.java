...
/**
 * A mock ONS Webservice to test json validation
 *
 */
public class MockONSWebservice extends ONSWebservice {
     ...
     */
    protected MockONSWebservice(Context context, State state) throws MalformedURLException {
