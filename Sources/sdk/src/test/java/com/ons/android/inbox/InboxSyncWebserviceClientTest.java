...
import static com.ons.android.inbox.FetcherType.USER_IDENTIFIER;
...
public class InboxSyncWebserviceClientTest {
    ...
    private String payloadJson =
        "{\"t\":\"c\",\"l\":\"https://pfs.gdn\",\"i\":\"test-send-id\",\"od\":{\"n\":\"02521fa3e-70e4-11ea-b5ac-bf057dd56464\",\"ct\":\"2918f6a1d46ff48c9e74bfded5d5d9c9e\"}}";
    ...
    public void testMissingNotificationInCache() throws Exception {
        ...
        payload.put("com.ons", payloadJson);
        payload.put("hip", "hop");
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            InboxNotificationContentInternal notification = new InboxNotificationContentInternal(
                ONSNotificationSource.CAMPAIGN,
                time,
                payload,
                identifiers
            );
        ...
        String fakeServerResponse =
            "{\"notifications\":[{\"installId\":\"b5baf3e0-a01f-11ea-111a-17c13e111be2\",\"notificationId\":\"test-id-2.5\",\"notificationTime\":10900000,\"sendId\":\"test-send-id-2.5\",\"payload\":{\"com.ons\":{\"t\":\"t\",\"l\":\"https://google.com\",\"i\":\"6y4g8guj-u1585829353322_68f3\",\"od\":{\"n\":\"c44d6340-74da-11ea-b3b3-8dc99181b65a\"}},\"msg\":\"test body\",\"title\":\"test title\"}},{\"notificationId\":\"test-id-2\"}],\"cache\":{\"lastMarkAllAsRead\":1585233902218},\"hasMore\":true,\"timeout\":false,\"cursor\":\"test-id-2\"}";
