...
import com.ons.android.ONSInboxFetcher;
...
public class InboxFetcherInternalTest {
    ...
    public void testFetchNewNotifications() throws Exception {
        ...
        fetcher.fetchNewNotifications(
            new ONSInboxFetcher.OnNewNotificationsFetchedListener() {
                @Override
                public void onFetchSuccess(
                    @NonNull List<ONSInboxNotificationContent> notifications,
        ...
        // Test markAsRead
        List<ONSInboxNotificationContent> notifications = fetcher.getPublicFetchedNotifications();
        Assert.assertEquals(6, notifications.size());

        ONSInboxNotificationContent notification = notifications.get(0);
        ...
        ONSInboxNotificationContent compareNotification = notifications.get(1);
