...
public class DITestUtils {
     ...
     * Must be in com.ons.android.di package to access DI protected methods and fields
     *
     * @param clazz
     * @param params
     * @param <T>
    ...
    public static <T> T mockSingletonDependency(Class<T> clazz, Class<?>[] paramsType, Object... params) {
        try {
            ...
            Class providerClass = Class.forName("com.ons.android.di.providers." + clazz.getSimpleName() + "Provider");
            Method getMethod;
            if (params.length > 0) {
