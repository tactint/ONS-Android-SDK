...
import com.ons.android.webservice.listener.impl.AttributesCheckWebserviceListenerImpl
import com.ons.android.webservice.listener.impl.AttributesSendWebserviceListenerImpl
...
class ProfileModuleTest : DITest() {
    ...
    override fun setUp() {
        ...
        Whitebox.setInternalState(ONS::class.java, "install", Install(context))
    ...
    fun testIdentifyWithNullID() {
        ...
        identifiers.put("install_id", ONS.User.getInstallationID())
    ...
    fun testTrackPublicEvent() {
        simulateONSStart(context)
        val eventData = ONSEventAttributes().apply {
    ...
    fun testCustomUserIdMigrationDisabled() {
        // Disable migration
        ONS.disableMigration(EnumSet.of(ONSMigration.CUSTOM_ID))
    ...
    fun testCustomDataMigration() {
        ...
        SQLUserDatasourceProvider.get(context).apply {
            ...
            setAttribute("url_att", URI("https://pfs.gdn/pricing"))
        ...
        val expectedParams = JSONObject().apply {
            ...
            put("custom_attributes", JSONObject().apply {
                ...
                put("url_att.u", URI("https://pfs.gdn/pricing"))
    ...
    fun testCustomDataMigrationDisabled() {
        // Disable migration
        ONS.disableMigration(EnumSet.of(ONSMigration.CUSTOM_DATA))
