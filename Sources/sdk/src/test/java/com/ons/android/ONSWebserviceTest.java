...
/**
 * Test ONS webservice global response reader
 *
 */
@RunWith(AndroidJUnit4.class)
@SmallTest
public class ONSWebserviceTest {
    ...
    public void testMissingHeader() throws Exception {
        MockONSWebservice ws = new MockONSWebservice(appContext, MockONSWebservice.State.MISSING_HEADER);
    ...
    public void testInvalidHeader() throws Exception {
        MockONSWebservice ws = new MockONSWebservice(appContext, MockONSWebservice.State.INVALID_HEADER);
    ...
    public void testMissingBody() throws Exception {
        MockONSWebservice ws = new MockONSWebservice(appContext, MockONSWebservice.State.MISSING_BODY);
    ...
    public void testComplete() throws Exception, Webservice.WebserviceError {
        MockONSWebservice ws = new MockONSWebservice(appContext, MockONSWebservice.State.COMPLETE);
    ...
    public void testPluginUserAgent() throws Exception {
        ...
        ws = new MockONSWebservice(appContext, MockONSWebservice.State.COMPLETE);
        headers = ws.getDefaultHeaders();
        assertNotNull(headers);
    ...
    public void testStatus() throws Exception {
        assertEquals(MockONSWebservice.get500ErrorReason(), MockONSWebservice.getResponseErrorCause(500));
        assertEquals(MockONSWebservice.get404ErrorReason(), MockONSWebservice.getResponseErrorCause(404));
    }
}
