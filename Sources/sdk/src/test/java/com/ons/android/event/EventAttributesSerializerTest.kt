...
class EventAttributesSerializerTest {
    ...
    fun testSerialize() {
        ...
        Assert.assertEquals("https://pfs.gdn/", attributes["url_attr.u"])
        ...
        Assert.assertEquals("https://pfs.gdn/", car["model_url.u"])
        ...
        Assert.assertEquals("https://pfs.gdn/", item["model_url.u"])
