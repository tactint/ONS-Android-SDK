...
public class DeeplinkTest {
    ...
    public void testValidDeeplink() {
        final String deeplink = "https://pfs.gdn";
    ...
    public void testCustomTabSchemes() {
        assertTrue(DeeplinkHelper.customTabSupportsURI(Uri.parse("https://pfs.gdn")));
        assertTrue(DeeplinkHelper.customTabSupportsURI(Uri.parse("HTTPS://pfs.gdn")));
        assertTrue(DeeplinkHelper.customTabSupportsURI(Uri.parse("http://pfs.gdn")));
        assertTrue(DeeplinkHelper.customTabSupportsURI(Uri.parse("HTTP://pfs.gdn")));

        assertFalse(DeeplinkHelper.customTabSupportsURI(Uri.parse("pfs.gdn")));

        assertFalse(DeeplinkHelper.customTabSupportsURI(Uri.parse("foobar://pfs.gdn")));
    }
}
